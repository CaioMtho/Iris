...
VALUES
  ('votacao-1', 'Marco Temporal das Terras Indígenas (PL 490/2007)', 'votacao', NULL, NULL, 'Projeto que estabelece que só podem ser demarcadas como terras indígenas áreas ocupadas até 05/10/1988. Aprovado na Câmara em maio de 2023; polêmica entre ruralistas e indigenistas.', 'Projeto que estabelece que só podem ser demarcadas como terras indígenas áreas ocupadas até 05/10/1988. Aprovado na Câmara em maio de 2023; polêmica entre ruralistas e indigenistas.', 'Projeto que estabelece que só podem ser demarcadas como terras indígenas... (resumo)', NOW(), NOW()),
  ('votacao-2', 'Lei Geral do Licenciamento Ambiental (PL 2159/2021)', 'votacao', NULL, NULL, 'Nova lei que simplifica o processo de licenciamento ambiental: prazos, licença única e digitalização. Debates sobre flexibilização ambiental.', 'Nova lei que simplifica o processo de licenciamento ambiental: prazos, licença única e digitalização. Debates sobre flexibilização ambiental.', 'Lei Geral do Licenciamento Ambiental (resumo)', NOW(), NOW()),
  ('votacao-3', 'Reforma Tributária (PEC 45/2019)', 'votacao', NULL, NULL, 'Reforma que propõe substituir diversos impostos por novos modelos (CBS/IBS). Simplificação e redistribuição do ônus tributário.', 'Reforma que propõe substituir diversos impostos por novos modelos (CBS/IBS).', 'Reforma Tributária (resumo)', NOW(), NOW()),
  ('votacao-4', 'Novo Arcabouço Fiscal (PLP 93/2023)', 'votacao', NULL, NULL, 'Substitui teto de gastos por novas regras fiscais; define limites e gatilhos para controle de despesas.', 'Substitui teto de gastos por novas regras fiscais; define limites e gatilhos para controle de despesas.', 'Novo Arcabouço Fiscal (resumo)', NOW(), NOW()),
  ('votacao-5', 'Imunidade Parlamentar (PEC 5/2021)', 'votacao', NULL, NULL, 'Proposta para ampliar imunidade parlamentar, discutindo limites e impactos para investigações.', 'Proposta para ampliar imunidade parlamentar, discutindo limites e impactos para investigações.', 'Imunidade Parlamentar (resumo)', NOW(), NOW()),
  ('votacao-6', 'Cotas Raciais em Concursos Públicos (Lei 12.990/2014 - Renovação)', 'votacao', NULL, NULL, 'Renovação/expansão da política de cotas raciais para concursos públicos, mantendo percentuais e mecanismos de verificação.', 'Renovação/expansão da política de cotas raciais para concursos públicos.', 'Cotas Raciais em Concursos Públicos (resumo)', NOW(), NOW())
